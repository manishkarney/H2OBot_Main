package edu.scu.cs.robotics.customviews;
...
public class JoystickPane {
    ...
    //I/O
    USBJoysticksInputSender mReadingsSender = null;
	...
	private void init() {
        ...
        final JoysticksInput inputReadings = ((H2OBotApplication)mActivity.getApplicationContext()).setUpAndGetJoysticksInput();
